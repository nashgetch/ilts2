...
function datatablesCtrl($scope, DTOptionsBuilder, posServices, deptServices, $location){
    ...
    $scope.dtOptions = DTOptionsBuilder.newOptions()
        ...
        .withButtons([
            {extend: 'copy'},
            {extend: 'csv'},
            {extend: 'excel', title: 'offices'},
            {extend: 'pdf', title: 'offices'},
    ...
    deptServices.getAllDepartments().success(function(response){
        $scope.office = response;
        console.log(response);
    });
    posServices.getAllPositions().success(function(response){
        $scope.pos = response;
        console.log(response);
    });
}
